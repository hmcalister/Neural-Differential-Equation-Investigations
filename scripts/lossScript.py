...
def performLossExperiment(lossStr: str, y0: torch.Tensor, trueCoefficientMatrix: torch.Tensor) -> pd.DataFrame:
    """
    Perform an experiment by giving a number of exponents corresponding to exponentCount to the network.

    Parameters
    ---
    lossStr: The loss function to use to train the ODEFunc
